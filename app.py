...
GMAIL_CIDRS = [
    # Gmail / Google Mail Proxy (AS15169)
    "66.102.0.0/20",
    "64.233.160.0/19",
    "74.125.0.0/16",
    "108.177.0.0/17",
    ...
    # Outlook / Hotmail / Microsoft Mail Proxy (AS8075)
    "13.64.0.0/11",
    "13.96.0.0/13",
    "20.36.0.0/14",
    "20.40.0.0/13",
    ...
    # Yahoo Mail / AOL / Verizon Media (AS26101 / AS14618)
    "66.218.64.0/18",
    "68.142.192.0/18",
    "69.147.64.0/18",
    "74.6.0.0/16",
    ...
    # Apple Mail Privacy Protection (AS714)
    "17.0.0.0/8",
